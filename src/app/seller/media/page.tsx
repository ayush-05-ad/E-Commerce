...
import { SellerMediaClient } from "@/components/seller/SellerMediaClient";
...
export default async function SellerMediaPage() {
  ...
  // 3. Fetch all images linked to products in this store
  ...
  return (
    <div className="min-h-screen bg-neutral-50/50 dark:bg-neutral-950/50 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-4">
        <SellerMediaClient initialImages={images} />
      </div>
    </div>
  );
}
